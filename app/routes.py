...
def reference_catalog():
    ...
    return render_template('catalog.html', books=books, collection_title="Reference Collection")
...
def scholastic_catalog():
    ...
    return render_template('catalog.html', books=books, collection_title="Scholastic Collection")
